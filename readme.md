...
- LAF GTM (Nome do plugin)
- laf-gtm (nome dos arquivos, nome do text domain e slug da url do repositório)
- LG_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- lg_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do LAF GTM, através do próprio sistema de atualizações do WordPress
